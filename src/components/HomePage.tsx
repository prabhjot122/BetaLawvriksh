...
function HomePage() {
  ...
  const handleFeedbackSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Transform data for backend - convert rating fields to integers and handle empty strings
      const transformedData = {
        ...feedbackData,
        // Convert rating fields to integers (or null if empty)
        visualDesign: feedbackData.visualDesign ? parseInt(feedbackData.visualDesign) : null,
        easeOfNavigation: feedbackData.easeOfNavigation ? parseInt(feedbackData.easeOfNavigation) : null,
        mobileResponsiveness: feedbackData.mobileResponsiveness ? parseInt(feedbackData.mobileResponsiveness) : null,
        overallSatisfaction: feedbackData.overallSatisfaction ? parseInt(feedbackData.overallSatisfaction) : null,
        easeOfTasks: feedbackData.easeOfTasks ? parseInt(feedbackData.easeOfTasks) : null,
        qualityOfServices: feedbackData.qualityOfServices ? parseInt(feedbackData.qualityOfServices) : null,
        // Convert empty strings to null for text fields
        likeMost: feedbackData.likeMost.trim() || null,
        improvements: feedbackData.improvements.trim() || null,
        features: feedbackData.features.trim() || null,
        legalChallenges: feedbackData.legalChallenges.trim() || null,
        additionalComments: feedbackData.additionalComments.trim() || null,
        contactEmail: feedbackData.contactEmail.trim() || null,
        visualDesignIssue: feedbackData.visualDesignIssue.trim() || null,
        easeOfNavigationIssue: feedbackData.easeOfNavigationIssue.trim() || null,
        mobileResponsivenessIssue: feedbackData.mobileResponsivenessIssue.trim() || null,
        overallSatisfactionIssue: feedbackData.overallSatisfactionIssue.trim() || null,
        easeOfTasksIssue: feedbackData.easeOfTasksIssue.trim() || null,
        qualityOfServicesIssue: feedbackData.qualityOfServicesIssue.trim() || null,
        // Handle contactWilling field
